...
class SudokuSolverTest extends FunSuite {
  ...
  test("should solve sudoku") {
    ...
    // then
    val expected = Array(Array('5','3','4','6','7','8','9','1','2'),
    ...
    assert(board.zipWithIndex.forall{a => a._1.sameElements(expected(a._2))})
  }

  test("should solve another sudoku") {
    // given
    val board = Array(Array('.','.','9','7','4','8','.','.','.'),
                      Array('7','.','.','.','.','.','.','.','.'),
                      Array('.','2','.','1','.','9','.','.','.'),
                      Array('.','.','7','.','.','.','2','4','.'),
                      Array('.','6','4','.','1','.','5','9','.'),
    ...
    // then
    val expected = Array(Array('5','1','9','7','4','8','6','3','2'),
